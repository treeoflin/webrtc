...
static jlong AddActionCallbackForTesting(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller,
...
JNI_GENERATOR_EXPORT jlong
    ...
    env, jclass jcaller,
    jobject callback) {
  return AddActionCallbackForTesting(env,
      base::android::JavaParamRef<jclass>(env, jcaller),
      base::android::JavaParamRef<jobject>(env, callback));
}

static void RemoveActionCallbackForTesting(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller,
    jlong callbackId);
...
JNI_GENERATOR_EXPORT void
    ...
    env, jclass jcaller,
    jlong callbackId) {
  return RemoveActionCallbackForTesting(env,
