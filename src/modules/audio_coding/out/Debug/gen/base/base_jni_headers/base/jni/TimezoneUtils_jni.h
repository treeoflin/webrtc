...
JNI_REGISTRATION_EXPORT extern const char
    kClassPath_org_chromium_base_TimezoneUtils[];
const char kClassPath_org_chromium_base_TimezoneUtils[] =
    "org/chromium/base/TimezoneUtils";

// Leaking this jclass as we cannot use LazyInstance from some threads.
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord
    g_org_chromium_base_TimezoneUtils_clazz = 0;
...
static base::subtle::AtomicWord
    g_org_chromium_base_TimezoneUtils_getDefaultTimeZoneId = 0;
static base::android::ScopedJavaLocalRef<jstring>
    Java_TimezoneUtils_getDefaultTimeZoneId(JNIEnv* env) {
  CHECK_CLAZZ(env, org_chromium_base_TimezoneUtils_clazz(env),
      org_chromium_base_TimezoneUtils_clazz(env), NULL);
  jmethodID method_id =
      base::android::MethodID::LazyGet<
      base::android::MethodID::TYPE_STATIC>(
      env, org_chromium_base_TimezoneUtils_clazz(env),
...
"Ljava/lang/String;",
  ...
  jstring ret =
static_cast<jstring>(env->CallStaticObjectMethod(org_chromium_base_TimezoneUtils_clazz(env),
          method_id));
